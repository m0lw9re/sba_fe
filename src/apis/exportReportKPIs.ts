...
export const exportReportKPIs = {
  exportExcel: (params?: any, type?: "tab1" | "tab2" | "tab3") => {
    let url = `${
      type === "tab1"
        ? "/assets/api/v2/statistic/kpi_report/export_excel"
        : type === "tab2"
        ? "/assets/api/v1/Statistic/KPIReportWeek/export_excel"
        : "assets/api/v1/Statistic/KPIReportMonth/export_excel"
    }`;
