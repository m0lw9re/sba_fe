...
export const exportExcelReportWeek = {
  exportExcell: (params?: any, type?: "tab1" | "tab3") => {
    let url = `${
      type === "tab1"
        ? "/bussiness/api/v1/statistic/delay/export_excel"
        : "/bussiness/api/v1/statistic/delay/report/export_excel"
    }`;
