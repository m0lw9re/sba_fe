...
import { FilterCreateCollectSpent, StaffType } from "constant/types";
...
type Props = {
  filters: FilterCreateCollectSpent;
  setFilter: (filters: FilterCreateCollectSpent) => void;
};

const { INPUT, SELECT, DATE_PICKER } = TYPE_FIELD;
const { momentTime } = DATE_TIME_FORMAT;

const PhieuChiFilter: React.FC<Props> = ({ filters, setFilter }) => {
  const [filterData, setFilterData] = useState<FilterCreateCollectSpent>({});
