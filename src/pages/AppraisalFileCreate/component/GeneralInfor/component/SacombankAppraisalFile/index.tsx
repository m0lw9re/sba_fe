...
const SacombankAppraisalFile = forwardRef<RefProps>(({}, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    addSacombankAppraisalFile: form.submitForm,
  }));
  ...
  const handleAdd = (data: AppraisalFileLegalDocumentCreateType) => {
    form.setValues({
      legalDocuments: [
        ...
        { ...data, type: APPRAISAL_LEGAL_DOCUMENT_TYPE.SACOMBANK },
      ],
    });
  };
...
export default SacombankAppraisalFile;
