...
import "pages/AppraisalFileCreate/component/GeneralInfor/component/EditLegalModal/style.scss";
...
type Props = {
  ...
  edit: (data: any, key: string) => void;
  assetLevelTwoId: number | null;
};

const { TEXT_AREA, SELECT } = TYPE_FIELD;

const initialValue: AppraisalFileLegalDocumentCreateType & {
  filesLength: number;
} = {
  ...newItem,
  filesLength: 0,
