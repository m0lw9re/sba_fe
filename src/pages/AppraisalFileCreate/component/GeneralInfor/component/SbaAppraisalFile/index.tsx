...
const SbaAppraisalFile = forwardRef<RefProps>(({}, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    addSbaAppraisalFileInfor: form.submitForm,
  }));
  ...
  const handleAdd = (data: AppraisalFileLegalDocumentCreateType) => {
    form.setValues({
      legalDocuments: [
        ...
        { ...data, type: APPRAISAL_LEGAL_DOCUMENT_TYPE.SBA },
      ],
    });
  };
...
export default SbaAppraisalFile;
