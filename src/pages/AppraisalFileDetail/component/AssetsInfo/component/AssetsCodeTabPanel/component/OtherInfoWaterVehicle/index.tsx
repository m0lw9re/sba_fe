...
const OtherInfoWaterVehicle = forwardRef<RefProps, Props>(
  ({ otherInfor, assetlevel2 }, ref) => {
    ...
    useImperativeHandle(ref, () => ({
      updateOtherInfoWaterVehicle: async () => {
    ...
    const inputFields: InputFiledParams[] = [
      ...
      },
      {
        ...
        css: css,
        value: form.values.numberOfDaysUsed,
        error: form.errors.numberOfDaysUsed,
        touched: form.touched.numberOfDaysUsed,
        labelCol: { xs: 4, sm: 4, md: 4, lg: 8, xl: 8 },
        wrapperCol: { xs: 20, sm: 20, md: 20, lg: 16, xl: 16 },
        onChange: (value: number) => {
          handleChange({
            numberOfDaysUsed: numberUtils.roundTwoDigitsDecimalNumber(value),
          });
        },
        currencable: true,
        min: 0,
...
export default OtherInfoWaterVehicle;
