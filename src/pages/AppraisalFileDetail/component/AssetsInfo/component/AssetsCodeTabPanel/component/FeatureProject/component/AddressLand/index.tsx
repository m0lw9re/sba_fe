...
const formSchema = Yup.object().shape({
  realAddressDetail: Yup.string()
    .nullable()
    .test("realAddressDetailFormSchema", "Chỉ nhập được 500 ký tự", (val) =>
  ...
  const dataSource = [
    {
      ...
      detail: (
        <FormItem
          ...
          touched={form.touched.legalAddressDetail}
        />
      ),
    },
    {
...
export default memo(AddressLand, (prevProps, nextProps) =>
