  ...
  const inputs: InputFiledParams[] = [
    {
      ...
      value: formCreateNewData.values.dateUpload
        ? dayjs(formCreateNewData.values.dateUpload)
        : null,
      error: formCreateNewData.errors.dateUpload,
      touched: formCreateNewData.touched.dateUpload,
      onChange: (value: any) => {
        handleChangeValue({
