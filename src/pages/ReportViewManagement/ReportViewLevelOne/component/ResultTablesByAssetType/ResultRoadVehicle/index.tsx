...
export const ResultByRoadVehicle: FC<Props> = (props) => {
    ...
    <Space direction="vertical" size="middle" style={{ width: "100%" }}>
      <Space direction="vertical" size="middle" style={{ width: "100%" }}>
        ...
        <Table
          ...
          bordered
          columns={columns}
          // dataSource={approvalHistoryValues?.sort((a, b) => Number(a?.valuationResultLandEstateId) - Number(b?.valuationResultLandEstateId)) || []}
          dataSource={approvalHistoryValues || []}
          pagination={false}
        />
      </Space>
