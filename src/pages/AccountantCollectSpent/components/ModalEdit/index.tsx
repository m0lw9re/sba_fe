...
import { EditAccountantCollectSpent } from "constant/types/accountantcollectspent";
...
type Props = {
  isOpen: boolean;
  closeModal: () => void;
  edit?: EditAccountantCollectSpent;
};

const { INPUT, SELECT } = TYPE_FIELD;

const initialValues: EditAccountantCollectSpent = {
  expentId: null,
  expentName: "",
  type: "",
  description: "",
...
const Edit: React.FC<Props> = ({ isOpen, closeModal, edit }) => {
  const form = useFormik({
    ...
    onSubmit: async (data: EditAccountantCollectSpent) => {},
  });
