...
type Props = {
  ...
  setFilters: (filters: FilterReportWeek) => void;
};

const ReportWeekFilter: React.FC<Props> = ({ filters, setFilters }) => {
  const [filterData, setFilterData] = useState<FilterReportWeek>({
    dateFrom: null,
    dateTo: null,
  });
