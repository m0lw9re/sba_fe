...
type Props = {
  ...
  setFilters: (filters: FilterReportTotalLate) => void;
};

const ReportTotalLateFilter: React.FC<Props> = ({ filters, setFilters }) => {
  const [filterData, setFilterData] = useState<FilterReportTotalLate>({
    dateFrom: null,
    dateTo: null,
  });
...
export default ReportTotalLateFilter;
