...
const ReportDetailWeekFilter: React.FC<Props> = ({ filters, setFilters }) => {
  const [filterData, setFilterData] = useState<FilterReportDetailWeek>({
    startDate: null,
    endDate: null,
  });
...
export default ReportDetailWeekFilter;
