...
const DebtComparisonFilter: React.FC<Props> = ({ filters, setFilters }) => {
  const [filterData, setFilterData] = useState<FilterDebtComparison>({
    dateFrom: null,
    dateTo: null,
  });
...
export default DebtComparisonFilter;