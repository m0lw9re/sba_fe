...
const ReportDebtMonthYearFilter: React.FC<Props> = ({
  filters,
  setFilters,
}) => {
  const [filterData, setFilterData] = useState<FilterReportDebtMonthYear>({
    dateFrom: null,
    dateTo: null,
  });
      ...
      itemList={[
        {
          ...
          children: (
            <Form labelAlign="left" labelWrap size="small">
              <Row gutter={[16, 4]} style={{ marginBottom: "8px" }}>
                  ...
                  <ButtonCustom
                    ...
                    onClick={() => {
                      if (!filterData.dateFrom && !filterData.dateTo) {
                        message.warning(
                          "Vui lòng chọn ít nhất một ngày để tìm kiếm!"
                        );
                        return;
                      }
                      setFilters({
...
export default ReportDebtMonthYearFilter;
