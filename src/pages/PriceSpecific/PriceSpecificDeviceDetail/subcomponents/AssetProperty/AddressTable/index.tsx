...
import {
  defaultColumns,
} from "pages/PriceSpecific/PriceSpecificDeviceDetail/subcomponents/AssetProperty/AddressTable/config";
  ...
  const datasource: Array<any> = [
    {
      ...
      streetCode: data?.addressStreet ? data?.addressStreet : '-',
      subStreetCode: data?.addressDetail ? data?.addressDetail : '-',
      detail: data?.address ? data?.address : '-',
    },
  ];
