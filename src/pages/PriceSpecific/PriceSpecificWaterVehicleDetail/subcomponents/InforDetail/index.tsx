...
import "pages/PriceSpecific/PriceSpecificWaterVehicleDetail/subcomponents/InforDetail/style.scss";
...
const InforDetail: React.FC<Props> = ({ data }) => {
  ...
  const inforDetails = [
    ...
    },
    {
      key: 2,
      label: "Phân loại kho",
      value: data?.storedTypeId ? categoryCommonsOptions.find(item => item.value === data?.storedTypeId)?.label  : "-",
    },
    {
      key: 3,
      label: "Mã Clims",
