...
import ModalViewPhieuThu from "../ModalView";
...
const AccountantApproveThuTable: FC<Props> = ({
  filters,
  onAddNew,
  onEdit,
}) => {
  ...
  return (
    <div className="phieu-thu-container">
      <Card className="card-container" size="small">
        ...
        >
          <CardTitleCustomUpdate title="Danh sách phiếu thu" />
        </div>
        <TableCustom
...
export default AccountantApproveThuTable;
