...
import AddAdjustCriteriaModal from "pages/AppendixMethods/component/Land/TableAdjustInfoLand/component/AddAdjustCriteriaModal";
...
const TableAdjustInfoApartment: FC<Props> = ({
  adjustTable,
  storedAssets,
  ...
  const CalSummaryTable = () => {
    ...
    localAdjustTable.forEach((el: any, index) => {
      ...
      const PriceChenhLech = Math.round((totalRatios[index] * unitPrice) / 100);
...
export default TableAdjustInfoApartment;
