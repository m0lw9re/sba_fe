...
import AddAdjustCriteriaModal from "pages/AppendixMethods/component/Machine/TableAdjustInfoMachine/component/AddAdjustCriteriaModal";
...
const TableAdjustInfoMachine: FC<Props> = ({
  adjustTable,
  storedAssets,
...
export default TableAdjustInfoMachine;
