...
type Props = {
  ...
  setFilter: (filter: FilterCategoryDepartmentType) => void;
};

const { INPUT } = TYPE_FIELD;

const CategoryDepartmentFilter: FC<Props> = ({ filter, setFilter }) => {
  const [filterData, setFilterData] = useState<FilterCategoryDepartmentType>(
    {},
  );
...
export default CategoryDepartmentFilter;
