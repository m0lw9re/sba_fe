...
const WaterwayVehiclesTable = () => {
  ...
  const { data, isLoading, error, mutate } = useAssetLevelThree(4, "false");
...
export default WaterwayVehiclesTable;
