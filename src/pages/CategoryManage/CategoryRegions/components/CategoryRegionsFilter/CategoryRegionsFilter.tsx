...
type Props = {
  ...
  setFilter: (filter: FilterCategoryRegionsType) => void;
};

const { INPUT } = TYPE_FIELD;

export const CategoryRegionsFilter: FC<Props> = ({ filters, setFilter }) => {
  const [filterData, setFilterData] = useState<FilterCategoryRegionsType>({});
...
export default CategoryRegionsFilter;
