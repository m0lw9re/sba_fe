...
import {
  defaultItem,
  initialValue,
} from "pages/PriceShared/AssetCreate/EstimateAsset/config";
import {
  useAddressProvince,
  useDataSource,
  useSourceInfor,
...
type Props = {
  compareAssets: Array<ComparedAssetEstimateCreateType>;
  onChangeCompareAssets: (data: Array<ComparedAssetEstimateCreateType>) => void;
  errors: any;
  touched: any;
...
const TableAssetInfo: React.FC<Props> = ({
  ...
  const handleConvertData = (
    data: Array<ComparedAssetEstimateCreateType>
  ): any[] => {
    if (!data) return [];
    let datasource = [];
