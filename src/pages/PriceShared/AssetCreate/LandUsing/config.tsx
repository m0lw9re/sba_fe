...
const initialValue: Array<ComparedAssetLandEstateCreateType> = [];

const defaultItem: ComparedAssetLandEstateCreateType = {
  key: "",
  assetCode: null,
  dataSourceId: null,
  infoSourceId: null,
...
for (let i = 0; i < 1; i++) {
  const item: ComparedAssetLandEstateCreateType = {
    ...defaultItem,
    key: randomId(),
  };
