import { ComparedAssetProjectCreateType } from "constant/types";
import { randomId } from "utils";

const initialValue: Array<ComparedAssetProjectCreateType> = [];

const defaultItem: ComparedAssetProjectCreateType = {
  key: "",
  assetCode: null,
  dataSourceId: null,
  infoSourceId: null,
...
for (let i = 0; i < 1; i++) {
  const item: ComparedAssetProjectCreateType = {
    ...defaultItem,
    key: randomId(),
  };
