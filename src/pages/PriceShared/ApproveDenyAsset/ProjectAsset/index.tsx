...
import "pages/PriceShared/ApproveDenyAsset/ProjectAsset/style.scss";
...
import TableAssetInfo from "pages/PriceShared/ApproveDenyAsset/ProjectAsset/TableAssetInfo";
...
const ProjectAsset = () => {
  ...
  const { data: assetInfor, mutate } = useAssetStoredDetail(ASSET_PRICES_SHARED_TYPE.PROJECT, id || "");
  ...
  useEffect(() => {
    let breadCrumb = [
      ...
      },
      {
        ...
        path: PRICE_SHARED_APPROVE_PROJECT.replace(":id", id || ""),
      },
    ];
      ...
      <div className="page-container">
        <Space direction="vertical" style={{ width: "100%" }}>
          <Row justify={"space-between"}>
            <Typography className="title">Phê duyệt tài sản Dự án</Typography>
            <Space>
