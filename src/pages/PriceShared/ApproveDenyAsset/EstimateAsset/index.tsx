...
import "pages/PriceShared/ApproveDenyAsset/EstimateAsset/style.scss";
...
import TableAssetInfo from "pages/PriceShared/ApproveDenyAsset/EstimateAsset/TableAssetInfo";
...
const EstimateAsset = () => {
  ...
  const { data: assetInfor, mutate } = useAssetStoredDetail(ASSET_PRICES_SHARED_TYPE.ESTIMATE, id || "");
  ...
  useEffect(() => {
    let breadCrumb = [
      ...
      },
      {
        ...
        path: PRICE_SHARED_APPROVE_ESTIMATE.replace(":id", id || ""),
      },
    ];
      ...
      <div className="page-container">
        <Space direction="vertical" style={{ width: "100%" }}>
          <Row justify={"space-between"}>
            <Typography className="title">Phê duyệt tài sản Dự toán</Typography>
            <Space>
