...
const AssetListApprovalWaitingFilter: React.FC<Props> = ({
  filters,
  setFilter,
}) => {
  const [filterData, setFilterData] = useState<FilterSpecificPricesType>({ assetType: 0, dateFrom: null, dateTo: null });
                ...
                >
                  <Space>
                    <ButtonCustom
                      label="Xóa"
                      onClick={() => {
                        setFilter({ assetType: 0, dateFrom: null, dateTo: null });
                        setFilterData({ assetType: 0, dateFrom: null, dateTo: null });
                        setErrorSearch(null);
                      }}
                    />
                    <ButtonCustom
...
export default AssetListApprovalWaitingFilter;
