...
type Props = {
  ...
  setFilter: (filter: FilterAccountRoleType) => void;
};

const { INPUT } = TYPE_FIELD;

const AccountRoleFilter: FC<Props> = ({ filter, setFilter }) => {
  const [filterData, setFilterData] = useState<FilterAccountRoleType>({});
