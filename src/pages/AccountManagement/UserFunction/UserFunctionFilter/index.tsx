...
import "pages/AccountManagement/UserFunction/UserFunctionFilter/style.scss";
...
const UserFunctionFilter: React.FC<Props> = ({ filters, setFilter }) => {
  ...
  const [filterData, setFilterData] = useState<{ roleCode?: string }>({});
  ...
  const inputSearch: InputFiledParams[] = [
    {
      ...
      onChange: (value: string) => setFilterData({ roleCode: value }),
    },
  ];
